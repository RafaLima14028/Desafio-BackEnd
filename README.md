...
Iremos executar um teste de integração para validar os cenários de uso. Por isso, sua aplicação deve seguir exatamente as especificações de APIs Rest do nosso Swager: request, response e status code. Garanta que os atributos dos JSONs e estão de acordo com o Swagger abaixo.
...
- Eu como usuário entregador quero me cadastrar na plataforma para alugar motos.
  - Os dados do entregador são( identificador, nome, cnpj, data de nascimento, número da CNH, tipo da CNH, imagemCNH)
